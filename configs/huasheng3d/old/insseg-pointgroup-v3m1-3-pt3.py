...
model = dict(
    ...
    cluster_propose_points=10,
    cluster_min_points=50,
    class_weights=[2, 1.0, 6],
    test=True,
)
...
data_root = "data/huasheng3d/source"
data_test_root = "data/huasheng3d/source_gt/9test"
# data_test_root = "data/huasheng3d/source"
