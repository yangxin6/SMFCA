...
data_root = "data/corn3d_group/exp_datasets/20240605_vega_800_mq_group3"
data_test_root = "data/corn3d_group/data_public/uav/"
...
data = dict(
    ...
    train=dict(
        ...
        transform=[
            ...
            dict(type="FilterMinInst", num=100),
            dict(
