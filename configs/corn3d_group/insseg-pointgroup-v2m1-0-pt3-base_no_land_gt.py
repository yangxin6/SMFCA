...
model = dict(
    ...
    cluster_thresh=0.08,  # 0.06
    cluster_min_points=50,  # 300
    test=False,
)
...
data_root = "data/corn3d_group/exp_datasets/gt_com_crop_800_4_d"
data_test_root = "data/corn3d_group/gt_lidar_full"
