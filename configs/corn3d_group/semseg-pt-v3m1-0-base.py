...
model = dict(
    ...
    criteria=[
        dict(type="CrossEntropyLoss", weight=[16.4, 1.1], loss_weight=1.0, ignore_index=-1),
    ],
)
...
data_root = "data/corn3d_group/exp_datasets/20240104_single_vega"
data_test = "data/corn3d_group/exp_datasets/20240104_single_vega"
