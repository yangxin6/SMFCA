...
model = dict(
    ...
    # class_weights=[6.1, 0.5],
    class_weights=[3.8, 0.6],
    test=True,
)
...
# dataset settings
dataset_type = "Corn3dOrganInstTxTDataset"
data_root = "data/corn3d_group/exp_datasets/group_train"
data_test_root = "data/corn3d_group/exp_datasets/group_train"
