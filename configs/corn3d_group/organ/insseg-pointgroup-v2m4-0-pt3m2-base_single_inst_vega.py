...
epoch = 400
eval_epoch = 100
optimizer = dict(type='AdamW', lr=0.0006, weight_decay=0.02)
scheduler = dict(
    type="OneCycleLR",
    max_lr=optimizer["lr"],
    pct_start=0.05,
...
data_root = "data/corn3d_group/exp_datasets/20240218_cs_3c"
data_test_root = "data/corn3d_group/exp_datasets/PACA_N"
