...
model = dict(
    ...
    class_weights=[1., 1.],
    organ_semantic_num_classes=organ_num_classes,
    organ_class_weights=[1., 11.0, 1.],
    organ_segment_ignore_index=organ_segment_ignore_index,
)
...
data_root = "data/corn3d_group/20240325_cs_group"
data_test_root = "data/corn3d_group/test_datasets_ground"
