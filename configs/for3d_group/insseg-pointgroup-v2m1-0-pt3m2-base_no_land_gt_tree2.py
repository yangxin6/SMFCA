...
data_root = "data/corn3d_group/exp_datasets/scale_tree_data_pth"
data_test_root = "data/corn3d_group/exp_datasets/scale_tree_data_pth"
...
data = dict(
    ...
    train=dict(
        ...
        transform=[
            ...
            dict(type="RandomCropComXY", crop_size=[2, 2]),
            dict(type="RandomTreeMix", replace_ratio=0.3, replace_application_ratio=0.5, template_path="/home/yangxin/data1/3d_qunti/exp_datasets/scale_tree_data_pth/tree_inst.npz"),
            dict(
