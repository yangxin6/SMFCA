...
model = dict(
    ...
    criteria=[dict(type="CrossEntropyLoss", loss_weight=1.0, ignore_index=segment_ignore_index)],
)
...
data_test = "data/corn3d_group_semantic/fast/exp_datasets/dales_til_8_pth/res_pth"
...
test = dict(type="SemSegTesterFile", verbose=True)
