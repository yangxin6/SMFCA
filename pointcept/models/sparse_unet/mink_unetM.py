...
class MinkUNetMBase(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, dimension=3):
        super().__init__()
        assert ME is not None, "Please follow `old-README.md` to install MinkowskiEngine.`"
        self.D = dimension
    ...
    def forward(self, data_dict):
        ...
        decoder_feats = [out_d5, out_d4, out_d3, out_d2, out_d1]

        return out, decoder_feats


@MODELS.register_module()
class MinkUNetM14(MinkUNetMBase):
    BLOCK = BasicBlock
    LAYERS = (1, 1, 1, 1, 1, 1, 1, 1)


@MODELS.register_module()
class MinkUNetM18(MinkUNetMBase):
    BLOCK = BasicBlock
    LAYERS = (2, 2, 2, 2, 2, 2, 2, 2)


@MODELS.register_module()
class MinkUNetM34(MinkUNetMBase):
    BLOCK = BasicBlock
    LAYERS = (2, 3, 4, 6, 2, 2, 2, 2)


@MODELS.register_module()
class MinkUNetM50(MinkUNetMBase):
    BLOCK = Bottleneck
    LAYERS = (2, 3, 4, 6, 2, 2, 2, 2)


@MODELS.register_module()
class MinkUNetM101(MinkUNetMBase):
    BLOCK = Bottleneck
    LAYERS = (2, 3, 4, 23, 2, 2, 2, 2)


@MODELS.register_module()
class MinkUNetM14A(MinkUNetM14):
    PLANES = (32, 64, 128, 256, 128, 128, 96, 96)

@MODELS.register_module()
class MinkUNetM14B(MinkUNetM14):
    PLANES = (32, 64, 128, 256, 128, 128, 128, 128)


@MODELS.register_module()
class MinkUNetM14C(MinkUNetM14):
    PLANES = (32, 64, 128, 256, 192, 192, 128, 128)


@MODELS.register_module()
class MinkUNetM14D(MinkUNetM14):
    PLANES = (32, 64, 128, 256, 384, 384, 384, 384)


@MODELS.register_module()
class MinkUNetM18A(MinkUNetM18):
    PLANES = (32, 64, 128, 256, 128, 128, 96, 96)


@MODELS.register_module()
class MinkUNetM18B(MinkUNetM18):
    PLANES = (32, 64, 128, 256, 128, 128, 128, 128)


@MODELS.register_module()
class MinkUNetM18D(MinkUNetM18):
    PLANES = (32, 64, 128, 256, 384, 384, 384, 384)


@MODELS.register_module()
class MinkUNetM34A(MinkUNetM34):
    PLANES = (32, 64, 128, 256, 256, 128, 96, 96)


@MODELS.register_module()
class MinkUNetM34B(MinkUNetM34):
    PLANES = (32, 64, 128, 256, 256, 128, 64, 32)


@MODELS.register_module()
class MinkUNetM34C(MinkUNetM34):
    PLANES = (32, 64, 128, 256, 256, 128, 96, 96)
